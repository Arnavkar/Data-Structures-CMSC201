...
public class FractionTests{
  ...
  public void gcdTest4(){ 
   BigInteger n = BigInteger.valueOf(-99);
   BigInteger x = BigInteger.valueOf(66);
   assertEquals(BigInteger.valueOf(33),n.gcd(x)); //GCD always positive
  }
  ...
  // public void equalityTestPrime1(){
  //   Fraction big = new Fraction(99,66);
  ...
  // }
   ...
   // @Test  // To test and make sure assertTrue can fail
  // public void equalityTestPrime2(){
  //   Fraction big = new Fraction(99,66);
